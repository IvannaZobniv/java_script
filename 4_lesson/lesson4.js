...
let h=1;
while (h<21) {
    document.write(`<h1>${h}довільний текст</h1>`);
    h++;
}
// ------------------------------------------------------
...
// адекватну стилізацію. Великими літерами прописанні властивості об'єкту які потрібно впровадити в шаблон
// ШАБЛОН
...
for (const product of products) {
    document.write(`
    <div class="product-card" style="text-transform:uppercase;">
    <h3 class="product-title"> 
    <li > <span style="color: red"> TITLE - </span>  ${product.title} </li> 
